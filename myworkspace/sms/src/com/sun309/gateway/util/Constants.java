...
public final class Constants
{
	...
	public static final String DB_PROPERTIES								= "/gatewaydb.properties";
	...
	public static final int SEND_DATA_THREAD_SLEEP_TIME				 		= 1000 *  1 * 1;				//发送数数的线程睡觉的时间
	public static final int SEND_SP1_DATA_THREAD_SLEEP_TIME				 	= 1000 *  14 * 1;				//发送数数的线程睡觉的时间
	...
	public static final int GET_SP1_RPT_DATA_THREAD_SLEEP_TIME  			= 1000 *  60 * 4;				//获取回执线程的睡觉时间
	
	public static final int GET_MO_DATA_THREA_SLEEP_TIME				 	= 400 *  1 * 1;				//获取回复线程的睡觉时间
	public static final int GET_UNICOM_MO_DATA_THREA_SLEEP_TIME				= 450 *  1 * 1;				//获取回复线程的睡觉时间(联通)
	...
	public static final int RE_SEND_MESSAGES_TIME						 	= 1000 * 60 * 60 * 60 * 1;			//当messages_stutas中的read_time超过4小时，重新发送该短信
