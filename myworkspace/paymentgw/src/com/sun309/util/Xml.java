...
public class Xml
{
	...
	public String setXmlAttr(String item, String _node, ArrayList<Hashtable<String, String>> list)
	{
		...
		for (Hashtable<String, String> ht : list) 
		{
			...
			for (String node : ht.keySet())
			{
				...
				_result.append(node).append("=\"").append(nodeValue).append("\" ");
			}
	...
	{
		return new StringBuffer("<?xml version='1.0' encoding='utf-8'?><root><error>").append(error).append("</error><message>").append(message).append("</message></root>").toString();
	}
