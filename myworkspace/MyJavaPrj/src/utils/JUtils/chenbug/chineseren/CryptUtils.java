...
public class CryptUtils {   
   ...
   * @return byte[]  
   */   
  public static byte[] desDecrypt(javax.crypto.SecretKey key,   
      byte[] crypt) throws Exception {   
   ...
   * @return byte[]  
   */   
  public static String desDecrypt(javax.crypto.SecretKey key,   
      String crypt) throws Exception {   
   ...
   * @return byte[]  
   */   
  public static byte[] desEncrypt(javax.crypto.SecretKey key,   
      byte[] src) throws Exception {   
    javax.crypto.Cipher cipher = javax.crypto.Cipher.getInstance("DESede");   
   ...
   * @return byte[]  
   */   
  public static String desEncrypt(javax.crypto.SecretKey key,   
   ...
   *  
   * @param src byte[]  
   * @param key byte[] MD5算法密钥  
   * @throws Exception  
   * @return byte[] 16 bit digest  
   */   
  public static byte[] md5Digest(byte[] src, byte[] key) throws Exception {   
   ...
   * 利用MD5进行不可逆的加密  
   * @param src 要加密的字符串  
   * @return String 加密好的32位字符串  
   * @throws Exception  
   */   
  public static String md5Encrypt(String src) throws Exception {   
    String md5 = md5Digest(src);   
    return encodeHex(md5.getBytes());   
  }   
   
  /**  
   * 将bytes中的字节转化成双字节,可视的  
   * @param bytes 要转化的byte[]  
   * @return String 可视的字符串  
   */   
  ...
  public static void main(String[] args) {   
    ...
    try {   
      System.out.println("BASE64Encode Test 1234: " + base64Encode("1234"));   
      System.out.println("BASE64Decode Test 1234: " +   
          base64Decode(base64Encode("1234")));   
      byte[] md5Byte = md5Digest("1234".getBytes());   
      System.out.println("MD5Digest Test 1234 byte length: " + md5Byte.length);   
      String md5 = new String(md5Byte);   
      System.out.println("MD5Digest Test 1234 byte String: " + md5);   
      System.out.println("MD5Digest Test 1234 byte String length: " +   
          md5.length());   
      System.out.println("MD5Digest Test 1234 byte String.byte length: " +   
          md5.getBytes().length);   
    } catch(Exception ex) {   
      ex.printStackTrace();   
    }   
