        ...
        <div class="mid midgoodsprice">
            ...
            <div class="midgoodspricenav" onselectstart='return false'>
            	<ul >
                    ...
                    <li onclick="submitFS()"  class="active" >放射类</li>
...
%>
            ...
            <div align="center" style="margin-top:5px">
             	<a href = "drugs_UI04.jsp?curPage=1" ><img src="img/bt_org_01.png"  alt="首页" /></a>
				<a href = "drugs_UI04.jsp?curPage=<%=curPage-1%>" ><img src="img/bt_org_02.png"  alt="上一页" /></a>
				<a href = "drugs_UI04.jsp?curPage=<%=curPage+1%>" ><img src="img/bt_org_03.png"  alt="下一页" /></a>
				<a href = "drugs_UI04.jsp?curPage=<%=pageCount%>" ><img src="img/bt_org_04.png"  alt="尾页" /></a>
