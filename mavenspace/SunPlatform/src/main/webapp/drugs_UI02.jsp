    ...
    <div class="container changebg" >
        ...
        <div class="mid midgoodsprice">
            ...
            <div class="midgoodspricenav" onselectstart='return false'>
            	<ul >
                	<li onclick="submitCZ()"  class="active" >常规医疗项目</li>
...
<%
	...
	try{
		...
		stat.setString(1,"体检");
		stat.setString(2,"功能检查");
		stat.setString(3,"床位");
		stat.setString(4,"护理");
		stat.setString(5,"诊察费");
...
%>
            ...
            <div align="center" style="margin-top:5px">
             	<a href = "drugs_UI02.jsp?curPage=1" ><img src="img/bt_org_01.png"  alt="首页" /></a>
				<a href = "drugs_UI02.jsp?curPage=<%=curPage-1%>" ><img src="img/bt_org_02.png"  alt="上一页" /></a>
				<a href = "drugs_UI02.jsp?curPage=<%=curPage+1%>" ><img src="img/bt_org_03.png"  alt="下一页" /></a>
				<a href = "drugs_UI02.jsp?curPage=<%=pageCount%>" ><img src="img/bt_org_04.png"  alt="尾页" /></a>
